...
#ifndef LIBHURRICANE_BFD__INSTRUCTION_NET_HXX
#define LIBHURRICANE_BFD__INSTRUCTION_NET_HXX
...
namespace hurricane_bfd {
    ...
    class instruction_net: public instruction {
        friend class instruction;

    public:
        instruction_net(const inst_t& bits);
        instruction_net(const inst_t& bits, const std::string debug);
